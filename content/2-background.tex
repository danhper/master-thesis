...
listings~\ref{code:group-messages-js},~\ref{code:group-messages-swift}
and~\ref{code:group-messages-java}. All of these listings implement the
...
\begin{figure}
  \lstinputlisting[
    language=JavaScript,basicstyle=\footnotesize,
    label=code:group-messages-js,caption=Message grouping logic in JavaScript]
...
\begin{figure}
  \lstinputlisting[
    ...
    label=code:group-messages-java,caption=Message grouping logic in Java]
    {./snippets/GroupSort.java}
\end{figure}
%
\begin{figure}
  \lstinputlisting[
    language=Swift,basicstyle=\footnotesize,
    label=code:group-messages-swift,caption=Message grouping logic in Swift]
    {./snippets/GroupSort.swift}
\end{figure}
%
Listing~\ref{code:group-messages-js} is implemented in JavaScript,
listing~\ref{code:group-messages-java} is implemented in Java and
listing~\ref{code:group-messages-js} is implemented in Swift which are
...
issue.
\subsubsection{Shortcomings of existing approaches}
